...
class IconsCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout{
    ...
    typealias Icon = (name: String, code: UnicodeScalar)
    typealias Section = (name: String, code: UnicodeScalar, icons: [Icon])
    ...
    func loadIcons(){
        ...
        do{
            ...
            var section = Section(name: "", code: UnicodeScalar("0"), icons: [])
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        header.iconLabel.text = String(sections[indexPath.section].code)
        header.nameLabel.text = sections[indexPath.section].name
